...
rse_sva_cleaned_big      = readRDS("results/rse_sva_cleaned_big_noquantile_Neuclean_GEclean_newcuts_noPCA(dlpfc new groups).rds")
rse_sva_cleaned_age_grps = readRDS("results/rse_sva_cleaned_age_grps_noquantile_Neuclean_GEclean_newcuts_noPCA(dlpfc new groups).rds")


#Reading the metafile with estimated power for each rse-object
pwr.df = readRDS("C:/Users/mpariha1/Desktop/upload_to_google_drive/OneDrive - Johns Hopkins/Paper new analysis/Revision/new new beta/soft-thresholding-pwrs_fulltable_noquantile_Neuclean_GEclean_newcuts_noPCA(dlpfc new groups).rds")
...
setwd("C:/Users/mpariha1/Desktop/upload_to_google_drive/OneDrive - Johns Hopkins/Paper new analysis/Revision/new new net")
...
saveRDS(gene_module_list, "gene_module_list(dlpfc new groups).rds")
...
saveRDS(gene_module_metadf, "metadf_noquantile_GEclean_newcuts_noPCA_deepSplit4_Neuclean_byAll(dlpfc new groups).rds")