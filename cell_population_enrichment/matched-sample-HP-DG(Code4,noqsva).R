...
pwr.df  = readRDS("C:\\Users\\mpariha1\\Desktop\\upload_to_google_drive\\OneDrive - Johns Hopkins\\New_Project\\newResults\\sft_noAgeSqr_noPCAremoved_redone\\soft-thresholding-pwrs_fulltable__newproject_noAgeSqr_noPCAremoved_redone.rds")
