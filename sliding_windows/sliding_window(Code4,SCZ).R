...
pwr.df = readRDS("C:\\Users\\Madhur\\OneDrive - Johns Hopkins\\Sliding_Window_Networks\\sft.sliding.window (SchizoNew)\\soft-thresholding-pwrs_fulltable_SchizoNew_Neuclean_sliding_window.rds")
...
rse_sva_cleaned_big         = readRDS("C:/Users/Madhur/OneDrive - Johns Hopkins/results/rse_sva_SchizoNew_cleaned_big_noquantile_Neuclean_GEclean_newcuts_noPCA.rds")
...
setwd("C:\\Users\\Madhur\\OneDrive - Johns Hopkins\\Sliding_Window_Networks\\sft.sliding.window (SchizoNew)\\net")
...
saveRDS(metadf,file = "metadf (noquantile, Neuclean, sliding, SchizoNew).rds")
saveRDS(big_list,file = "big_list (noquantile, Neuclean, sliding, SchizoNew).rds")
...
saveRDS(big_list_grch38,file = "big_list (noquantile, Neuclean, sliding, SchizoNew)[grch38].rds")
