...
rse_sva_cleaned_big         = readRDS("rse_sva_SchizoNew_cleaned_big_noquantile_Neuclean_GEclean_newcuts_noPCA.rds")
...
setwd("C:\\Users\\mpariha1\\Desktop\\upload_to_google_drive\\OneDrive - Johns Hopkins\\Sliding_Window_Networks\\sft.sliding.window (SchizoNew)")
...
saveRDS(mm, "soft-thresholding-pwrs_fulltable_SchizoNew_Neuclean_sliding_window.rds")
saveRDS(li, "soft-thresholding-list_SchizoNew_Neuclean_sliding_window.rds")
