###############################################################################################
#                                Script to remove confounder effect                           # 
...
rse_preprocessed = readRDS("results/rse_preprocessed_SchizoNew_GEclean_newcuts.rds")        #Sample and gene outlier removed
...
setwd("results/")
saveRDS(rse.sva.cleaned.big_logRPKM ,"rse_sva_SchizoNew_cleaned_big_noquantile_Neuclean_GEclean_newcuts_noPCA.rds")
